// components/tours/tour-showcase/festival-tour-card.tsx
"use client";
...
import { ArrowUpRight, Clock, MapPin, Calendar, BadgeIndianRupee } from "lucide-react";
...
export function FestivalTourCard({ tour, index }: FestivalTourCardProps) {
