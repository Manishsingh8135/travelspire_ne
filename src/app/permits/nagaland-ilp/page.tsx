...
const Breadcrumb = () => (
  <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
    ...
    <ChevronRight className="w-4 h-4" />
    <span className="text-foreground font-medium">Nagaland ILP</span>
  </nav>
);
...
const EntryPointIcon = ({ type }: { type: string }) => {
  if (type.includes("Air")) return <Plane className="w-4 h-4" />;
  if (type.includes("Rail")) return <Train className="w-4 h-4" />;
...
export default function NagalandILPPage() {
    ...
    <main className="relative w-full overflow-hidden">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium text-primary-700 dark:text-primary-300">
                Updated for 2025 • Hornbill Festival Ready
              </span>
            </motion.div>

            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold">
              <span className="text-foreground dark:text-white">Nagaland</span>
              <br />
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl">
              {data.tagline}. Complete guide for Hornbill Festival, Kohima, Mon district 
              with step-by-step application process, fee structure, and expert tips.
            </p>
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              ...
              <Link
                href="https://wa.me/919864141211?text=Hi%20TravelSpire%20NE!%20%F0%9F%A6%85%0A%0AI%20need%20help%20with%20Nagaland%20ILP.%0A%0A%E2%80%A2%20Travel%20Dates%3A%20%0A%E2%80%A2%20Number%20of%20People%3A%20%0A%E2%80%A2%20Purpose%3A%20Hornbill%20Festival%20%2F%20Tourism%0A%0APlease%20assist%20me!"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <QuickStatCard 
              icon={IndianRupee} 
              label="Tourist Fee" 
              value={data.quickStats.fee.tourist30Days}
              highlight={true}
              subtext="30 days validity"
            />
            <QuickStatCard 
              icon={Clock} 
            ...
            <QuickStatCard 
              ...
              label="On Arrival" 
              value="Not Available"
              subtext="Online mandatory from Dec 2024"
            />
          </div>
          ...
          >
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-bold text-lg text-foreground dark:text-white">Official ILP Portal</h3>
            ...
            <div className="mt-4 flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span>Helpdesk: <strong>{data.quickStats.helpline}</strong></span>
            </div>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-100 dark:bg-orange-900/30 border border-orange-200 dark:border-orange-800 mb-4">
              <PartyPopper className="w-5 h-5 text-orange-600 dark:text-orange-400" />
              <span className="font-medium text-orange-700 dark:text-orange-300">Festival of Festivals</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold text-foreground dark:text-white mb-4">
              Hornbill Festival 2025
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              {data.hornbillFestival.description}
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="p-6 rounded-2xl bg-white/80 dark:bg-accent-800/80 border border-orange-200 dark:border-orange-800"
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="font-bold text-lg text-foreground dark:text-white">{data.hornbillFestival.name}</h3>
                  <p className="text-sm text-orange-600 dark:text-orange-400">{data.hornbillFestival.dates}</p>
                </div>
              </div>
              <p className="text-sm text-muted-foreground mb-4">
                <strong>Venue:</strong> {data.hornbillFestival.venue}
              </p>
              <h4 className="font-bold text-foreground dark:text-white mb-3">Festival Highlights</h4>
              <ul className="space-y-2">
                {data.hornbillFestival.highlights.map((highlight, i) => (
            ...
            {/* ILP Tips for Festival */}
            <motion.div
              initial={{ opacity: 0, x: 20 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="p-6 rounded-2xl bg-gradient-to-br from-orange-500 to-red-600 text-white"
            >
              <h3 className="font-bold text-xl mb-4 flex items-center gap-2">
                <FileText className="w-6 h-6" />
                ILP Tips for Hornbill Festival
              </h3>
              <ul className="space-y-3">
                {data.hornbillFestival.ilpTips.map((tip, i) => (
              ...
              <Link
                href="https://wa.me/919864141211?text=Hi%20TravelSpire%20NE!%20%F0%9F%A6%85%0A%0AI%20want%20to%20attend%20Hornbill%20Festival%202025!%0A%0A%E2%80%A2%20Dates%3A%20December%201-10%0A%E2%80%A2%20Number%20of%20People%3A%20%0A%0APlease%20help%20me%20with%20ILP%20and%20tour%20package!"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 mt-6 px-6 py-3 rounded-full bg-white text-orange-600 font-bold hover:bg-orange-50 transition-colors"
              >
                <MessageCircle className="w-5 h-5" />
                Book Hornbill Festival Package
              </Link>
            </motion.div>
          </div>
        </div>
      ...
      <section className="relative py-12 md:py-16 bg-primary-50/30 dark:bg-accent-900/30">
        <div className="max-w-4xl mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-foreground dark:text-white mb-4">
              How to Apply for Nagaland ILP Online
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Step-by-step guide - Online application only (offline discontinued from Dec 2024)
            </p>
          </motion.div>
      ...
      <section className="relative py-12 md:py-16 bg-primary-50/30 dark:bg-accent-900/30">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-foreground dark:text-white mb-4">
              Important Tips for Nagaland ILP
            </h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 p-3 rounded-lg bg-primary-50 dark:bg-primary-950/30">
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground">Online Helpdesk</p>
              ...
              <h4 className="font-bold text-foreground dark:text-white mt-6 mb-3">Nagaland House Offices</h4>
              <div className="space-y-2">
                {data.contact.nagalandHouses.map((office) => (
            ...
            >
              ...
              <p className="text-white/90 mb-6">
                Don&apos;t want to deal with the hassle? Our local experts can help you get your Nagaland ILP quickly. Perfect for Hornbill Festival visitors!
              </p>
              ...
              <Link
                href="https://wa.me/919864141211?text=Hi%20TravelSpire%20NE!%20%F0%9F%A6%85%0A%0AI%20need%20help%20with%20Nagaland%20ILP.%0A%0A%E2%80%A2%20Travel%20Dates%3A%20%0A%E2%80%A2%20Number%20of%20People%3A%20%0A%E2%80%A2%20Places%20to%20Visit%3A%20%0A%0APlease%20assist%20me!"
                target="_blank"
                rel="noopener noreferrer"
