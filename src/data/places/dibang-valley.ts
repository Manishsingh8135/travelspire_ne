...
export const valleySeasons = [
  { month: "Jan", tone: "best", label: "Oranges low, snow high" },
  { month: "Feb", tone: "good", label: "Clear passes" },
  { month: "Mar", tone: "best", label: "Blossom to ridge" },
  { month: "Apr", tone: "good", label: "Warm, green" },
  { month: "May", tone: "caution", label: "Pre-monsoon haze" },
  { month: "Jun", tone: "avoid", label: "Monsoon begins" },
  { month: "Jul", tone: "avoid", label: "Floods, landslides" },
  { month: "Aug", tone: "avoid", label: "Roads at risk" },
  { month: "Sep", tone: "caution", label: "Fest season, wet roads" },
  { month: "Oct", tone: "best", label: "Post-monsoon clarity" },
  { month: "Nov", tone: "best", label: "Best overall month" },
  { month: "Dec", tone: "best", label: "Cold, empty, golden" },
] as const;
